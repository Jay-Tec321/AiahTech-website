    ...
    <head>
        ...
        <style>
            * {{ margin: 0; padding: 0; box-sizing: border-box; }}
            ...
            .computer-slide-info h3 {{ font-size: 26px; margin-bottom: 10px; }}
            .computer-slide-info .brand {{ opacity: 0.7; font-size: 15px; margin-bottom: 10px; }}
            .computer-slide-info .specs {{ opacity: 0.85; font-size: 14px; margin: 10px 0; line-height: 1.8; }}
            .computer-slide-info .price {{ font-size: 28px; font-weight: 700; color: #4ade80; margin: 12px 0; }}
